...
function selectScore() {
  ...
  document.getElementById("select_score").innerHTML =
    choose.length + "块 " + score + "分";
  ...
  for (var i = 0; i < boardWidth; i++) {
    ...
    for (var j = 0; j < boardWidth; j++) {
      ...
      square.onclick = function () {
        ...
        totalScore += score;
        document.getElementById("now_score").innerHTML =
          "当前分数：" + totalScore;
        //消灭星星
        for (var i = 0; i < choose.length; i++) {
          (function (i) {
