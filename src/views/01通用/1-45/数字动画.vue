    ...
    <div class="container">
      <template v-if="flag">
        ...
        <div class="card-content">
          <countup class="card-num color1" :end="endValue" />
          <div>用户访问量</div>
          <el-button type="primary" @click="increaseClick">+1</el-button>
        </div>
      </template>
      <template v-else>
        <div class="code">
...
/* 不改的代码 end */
const endValue = ref(2024);

const increaseClick = () => [endValue.value++];
</script>
