  ...
  <div class="home">
    <div class="container">
      <template v-if="flag">
        ...
        <NumberFlip :from="fromNumber" :to="toNumber" color="#fff"></NumberFlip>
        <el-button type="primary" @click="toClick">翻其它数字</el-button>
      </template>
      <template v-else>
        <div class="code">
...
const fromNumber = ref(0);
const toNumber = ref(112);

const toClick = () => {
  toNumber.value = Math.random();
};
</script>
