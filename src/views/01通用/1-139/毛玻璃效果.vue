		...
		<div class="container">
			...
			<div class="glass">
				...
				<div class="music-widget glass">
					...
					<div class="song-info">
						<div class="song-title">Current Song</div>
			...
			<div class="glass">
				...
				<div class="card-content">
					<div class="reminder-item">○ Pick up contacts</div>
					<div class="reminder-item">○ Order plant food</div>
					<div class="reminder-item">○ Water Monstera</div>
				</div>
			</div>
			...
			<div class="glass">
				...
				<div class="card-content">
					<p>The glass effect relies on transparency, background blur and thin edges to create depth.</p>
