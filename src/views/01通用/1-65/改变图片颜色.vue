	...
	<div class="home">
		<div class="containers">
			<template v-if="flag">
				...
				<Title :orderNum="1" context="使用canvas改变图片的颜色" :size="1" :color="9" :wight="1" :backgroundColor="3" />
				<canvas class="pic" ref="canvas"></canvas>
			</template>
			<template v-else>
				<div class="code">
...
onMounted(async () => {
	...
	nextTick(() => {
		...
		var img = new Image();
		img.src = '/@/assets/beauty/3/3-2.jpg';
		img.onload = function () {
			ctx.drawImage(img, 0, 0);
			ctx.globalCompositeOperation = 'source-atop';
			ctx.fillStyle = 'rgba(255, 0, 0, 0.5)'; // 纯红色
