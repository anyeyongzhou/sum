<template>
	<div class="home">
		<div class="container">
			<template v-if="flag">
				<Title :orderNum="1" context="echarts" :size="1" :color="9" :wight="1" :backgroundColor="3" />
...
import { OnlineUserAPI } from './data.ts';
...
const { options } = useECharts(chartRef, OnlineUserAPI.STREAM_SSE.chartOptions());
</script>
