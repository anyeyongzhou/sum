...
.home {
  ...
  .container {
    ...
    .demo-perspective-photo .mod-sun .y,
    .demo-perspective-photo .mod-sun .z {
      width: 200px;
      height: 200px;
      border-radius: 50%;
    }

    .demo-perspective-photo .mod-sun .x1,
    .demo-perspective-photo .mod-sun .x2,
    .demo-perspective-photo .mod-sun .y,
    .demo-perspective-photo .mod-sun .y1,
    .demo-perspective-photo .mod-sun .y2,
    .demo-perspective-photo .mod-sun .z,
    .demo-perspective-photo .mod-sun .z1,
    .demo-perspective-photo .mod-sun .z2,
    .demo-perspective-photo .mod-sun .xInner,
    .demo-perspective-photo .mod-sun .yInner,
    .demo-perspective-photo .mod-sun .zInner {
      position: absolute;
    }
    ...
    .demo-perspective-photo .example1 .y,
    .demo-perspective-photo .example1 .z {
      width: 30px;
      height: 30px;
      border-radius: 50%;
    }

    .demo-perspective-photo .example1 .x1,
    .demo-perspective-photo .example1 .x2,
    .demo-perspective-photo .example1 .y,
    .demo-perspective-photo .example1 .y1,
    .demo-perspective-photo .example1 .y2,
    .demo-perspective-photo .example1 .z,
    .demo-perspective-photo .example1 .z1,
    .demo-perspective-photo .example1 .z2,
    .demo-perspective-photo .example1 .xInner,
    .demo-perspective-photo .example1 .yInner,
    .demo-perspective-photo .example1 .zInner {
      position: absolute;
    }
    ...
    .demo-perspective-photo .example2 .y,
    .demo-perspective-photo .example2 .z {
      width: 45px;
      height: 45px;
      border-radius: 50%;
    }

    .demo-perspective-photo .example2 .x1,
    .demo-perspective-photo .example2 .x2,
    .demo-perspective-photo .example2 .y,
    .demo-perspective-photo .example2 .y1,
    .demo-perspective-photo .example2 .y2,
    .demo-perspective-photo .example2 .z,
    .demo-perspective-photo .example2 .z1,
    .demo-perspective-photo .example2 .z2,
    .demo-perspective-photo .example2 .xInner,
    .demo-perspective-photo .example2 .yInner,
    .demo-perspective-photo .example2 .zInner {
      position: absolute;
    }
    ...
    .demo-perspective-photo .example3 .y,
    .demo-perspective-photo .example3 .z {
      width: 55px;
      height: 55px;
      border-radius: 50%;
    }

    .demo-perspective-photo .example3 .x1,
    .demo-perspective-photo .example3 .x2,
    .demo-perspective-photo .example3 .y,
    .demo-perspective-photo .example3 .y1,
    .demo-perspective-photo .example3 .y2,
    .demo-perspective-photo .example3 .z,
    .demo-perspective-photo .example3 .z1,
    .demo-perspective-photo .example3 .z2,
    .demo-perspective-photo .example3 .xInner,
    .demo-perspective-photo .example3 .yInner,
    .demo-perspective-photo .example3 .zInner {
      position: absolute;
    }
    ...
    .demo-perspective-photo .example4 .y,
    .demo-perspective-photo .example4 .z {
      width: 110px;
      height: 110px;
      border-radius: 50%;
    }

    .demo-perspective-photo .example4 .x1,
    .demo-perspective-photo .example4 .x2,
    .demo-perspective-photo .example4 .y,
    .demo-perspective-photo .example4 .y1,
    .demo-perspective-photo .example4 .y2,
    .demo-perspective-photo .example4 .z,
    .demo-perspective-photo .example4 .z1,
    .demo-perspective-photo .example4 .z2,
    .demo-perspective-photo .example4 .xInner,
    .demo-perspective-photo .example4 .yInner,
    .demo-perspective-photo .example4 .zInner {
      position: absolute;
    }
    ...
    .demo-perspective-photo .example5 .y,
    .demo-perspective-photo .example5 .z {
      width: 70px;
      height: 70px;
      border-radius: 50%;
    }

    .demo-perspective-photo .example5 .x1,
    .demo-perspective-photo .example5 .x2,
    .demo-perspective-photo .example5 .y,
    .demo-perspective-photo .example5 .y1,
    .demo-perspective-photo .example5 .y2,
    .demo-perspective-photo .example5 .z,
    .demo-perspective-photo .example5 .z1,
    .demo-perspective-photo .example5 .z2,
    .demo-perspective-photo .example5 .xInner,
    .demo-perspective-photo .example5 .yInner,
    .demo-perspective-photo .example5 .zInner {
      position: absolute;
    }
    ...
    .demo-perspective-photo .example6 .y,
    .demo-perspective-photo .example6 .z {
      width: 85px;
      height: 85px;
      border-radius: 50%;
    }

    .demo-perspective-photo .example6 .x1,
    .demo-perspective-photo .example6 .x2,
    .demo-perspective-photo .example6 .y,
    .demo-perspective-photo .example6 .y1,
    .demo-perspective-photo .example6 .y2,
    .demo-perspective-photo .example6 .z,
    .demo-perspective-photo .example6 .z1,
    .demo-perspective-photo .example6 .z2,
    .demo-perspective-photo .example6 .xInner,
    .demo-perspective-photo .example6 .yInner,
    .demo-perspective-photo .example6 .zInner {
      position: absolute;
    }
