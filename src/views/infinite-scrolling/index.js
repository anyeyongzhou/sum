var nextPage = 1;
var divNoData = document.querySelector(".no-data");
var divLoading = document.querySelector(".loading");
var divList = document.querySelector(".movie-list");
var bottom = 100;
var loading = false;
function getMoreData(page, callback) {
    var movieData = [
...
function loadData() {
    ...
    getMoreData(nextPage, function (result) {
...
window.addEventListener("scroll", function () {
    ...
    if (scrollTop + height > scrollHeight - bottom) {
        loadData();
    }
})
