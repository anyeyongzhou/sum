<template>
	<el-container class="layout-container flex-center">
		...
		<div class="btn-list" v-if="route.path != '/home'">
			<el-button @click="gotoPre" size="small" type="primary"> 上一个 </el-button>
			<el-button @click="gotoHome" size="small" type="success"> 首页 </el-button>
			<el-button @click="gotoNext" size="small" type="primary"> 下一个 </el-button>
		</div>
	</el-container>
</template>
